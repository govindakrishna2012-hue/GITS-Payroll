...
const AD =
  'FLAT NO.201, KARRE COTTAGE, VI PHASE, KPHB COLONY, HYDERABAD-500072.';
const MS = [
  'Apr',
  'May',
  'Jun',
...
// Indian Financial Year Format
const fyL = (y) =>
  `${parseInt(y || 0)}-${String(parseInt(y || 0) + 1).slice(2)}`;
const mL = (m, y) =>
  `${m}-${String(
    ['Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'].includes(m)
      ? parseInt(y || 0)
      : parseInt(y || 0) + 1
  ).slice(2)}`;
...
// --- COMPLETE EMPLOYEE DATA (NO TRUNCATION) ---
const E0 = [
  {
    id: 'SRR1001',
    name: 'P.Umashankar Anand',
    desig: 'Senior Recruiter',
    pan: 'ALKPA8190Q',
    cat: 'Onshore',
    basic: 38500,
    phone: '9000000001',
    email: 'umashankar@gatewayit.in',
    pwd: 'SRR1001',
    start: '01-04-2024',
    end: '',
    status: 'Active',
    comments: '',
    bank: '209610100015027 ANDHRA BANK',
    driveLink:
      'https://drive.google.com/drive/folders/1ar5eR8ujvwnEaGWlCbrHdr7QcKyeZ0Ww?usp=sharing',
  },
  {
    id: 'SRR1003',
    name: 'V Sunil Kumar',
    ...
    basic: 44500,
    phone: '9000000002',
    email: 'sunil@gatewayit.in',
    pwd: 'SRR1003',
    start: '01-04-2024',
    end: '',
    status: 'Active',
    comments: '',
    bank: '209610100015028 ANDHRA BANK',
    driveLink:
      'https://drive.google.com/drive/folders/1ar5eR8ujvwnEaGWlCbrHdr7QcKyeZ0Ww?usp=sharing',
  },
  {
    id: 'ADMN1002',
    name: 'R Govinda Krishnan',
    desig: 'Accounts Manager',
    pan: 'AUPPK3079C',
    cat: 'Onshore',
    basic: 33000,
    phone: '9000000003',
    email: 'govinda@gatewayit.in',
    pwd: 'ADMN1002',
    start: '07-10-2013',
    end: '',
    status: 'Active',
  ...
  },
  {
    id: 'D1001',
    name: 'Nagaraju D',
    desig: 'Driver cum Office Boy',
    pan: 'ANJPD1432D',
    cat: 'Onshore',
    basic: 22000,
    phone: '9000000004',
    email: 'nagaraju@gatewayit.in',
    pwd: 'D1001',
    start: '01-04-2024',
    end: '',
    status: 'Active',
    comments: '',
    bank: '209610100015029 ANDHRA BANK',
    driveLink:
      'https://drive.google.com/drive/folders/15mCFlI5c6r0ChRwKUweyRVRhLtoThUEz?usp=sharing',
  },
  {
    id: 'ADMN1004',
    ...
    basic: 25000,
    phone: '9000000005',
    email: 'balamurali@gatewayit.in',
    pwd: 'ADMN1004',
    start: '01-04-2024',
    end: '',
    status: 'Active',
    comments: '',
    bank: '209610100015030 ANDHRA BANK',
    driveLink:
      'https://drive.google.com/drive/folders/13PU-Gx2Oj_ca00riE2wNeP_dS4kusHRv?usp=sharing',
  },
  {
    id: 'RR1026',
    name: 'Maneendra Basa',
    ...
    basic: 30000,
    phone: '9000000006',
    email: 'maneendra@gatewayit.in',
    pwd: 'RR1026',
    start: '01-04-2024',
    end: '',
    status: 'Active',
    comments: '',
    bank: '209610100015031 ANDHRA BANK',
    driveLink:
      'https://drive.google.com/drive/folders/1y2gs9n9uIc4leEE3UMmuJCJIzZkYTMMf?usp=drive_link',
  },
  {
    id: 'BA1001',
    name: 'Bhaskar Akkala',
    ...
    basic: 200000,
    phone: '9000000007',
    email: 'bhaskar@gatewayit.in',
    pwd: 'BA1001',
    start: '01-05-2024',
    end: '',
    status: 'Active',
    comments: '',
    bank: '209610100015032 ANDHRA BANK',
    driveLink:
      'https://drive.google.com/drive/folders/1gSw5MYcOybJdA9D6bnTInpTnQHeT13J3?usp=sharing',
  },
];

// --- COMPLETE HISTORICAL PAYROLL DATA (NO TRUNCATION) ---
const P0 = {
  SRR1001: {
    2025: [
      {
      ...
      },
      {
        ...
        pt: 200,
        tds: 0,
        note: 'Leave encashment Rs.5,133',
      },
    ],
  },
  SRR1003: {
...
const buildSlip = (emp, mo, fyStr, entries, att) => {
  const sal = entries.find((r) => r.t === 's') || {
    basic: 0,
    hra: 0,
    conv: 0,
    med: 0,
...
<body>
  ...
  <div class="payslip-container">
    ...
    <div class="title">PAYSLIP FOR THE MONTH OF ${mo.toUpperCase()}-${fyStr.slice(
    -2
  )}</div>
    ...
    <table class="salary-details">
      ...
      <tbody>
        <tr>
          <td class="fw">BASIC</td><td class="tr">${f$(
            sal.basic
          )}</td><td class="tr">${f$(sal.basic)}</td>
        ...
        <tr>
          <td class="fw">HRA</td><td class="tr">${f$(
            sal.hra
          )}</td><td class="tr">${f$(sal.hra)}</td>
          <td>STAFF ADVANCE</td><td class="tr">${f$(sal.adv)}</td>
        </tr>
        <tr>
          <td class="fw">CONVEYANCE ALLOWANCE</td><td class="tr">${f$(
            sal.conv
          )}</td><td class="tr">${f$(sal.conv)}</td>
          <td>LOP</td><td class="tr">${f$(sal.lop)}</td>
        </tr>
        <tr>
          <td class="fw">MEDICAL ALLOWANCE</td><td class="tr">${f$(
            sal.med
          )}</td><td class="tr">${f$(sal.med)}</td>
          <td>NO OF LEAVES (LOP)</td><td class="tr">${lopDays} DAY/S</td>
        </tr>
        <tr>
          <td class="fw">INCENTIVES</td><td class="tr">${f$(
            incs
          )}</td><td class="tr">${f$(incs)}</td>
          <td>ADJUSTMENT DED</td><td class="tr">0</td>
        </tr>
        <tr>
          <td class="fw">ARREARS AND OTHERS</td><td class="tr">${f$(
            sal.oth
          )}</td><td class="tr">${f$(sal.oth)}</td>
    ...
    ${
      sal.note
        ? `<div style="font-size:12px;color:#555;margin-bottom:15px"><b>Note:</b> ${sal.note}</div>`
        : ''
    }
...
export default function App() {
  ...
  const addEmployee = () => {
    ...
    setEmps([...emps, { ...nE, basic: Number(nE.basic) }]);
    setPay({ ...pay, [nE.id]: {} });
    setAtt({ ...att, [nE.id]: {} });
    setShowAddEmp(false);
    setNE({
  ...
  const addLedgerEntry = () => {
    ...
    setPay({
      ...pay,
      [pEmp]: { ...pay[pEmp], [fy]: [...(pay[pEmp]?.[fy] || []), e] },
    });
  ...
  const openBulkPayroll = () => {
    ...
    emps
      ...
      .forEach((emp) => {
        defaults[emp.id] = {
          basic: emp.basic,
          hra: Math.round((emp.basic || 0) * 0.4),
          conv: 800,
          med: 1500,
          inc: 0,
          lop: 0,
  ...
  const saveBulkPayroll = () => {
    ...
    setPay(nextPay);
    setShowBulk(false);
    alert(`Bulk Payroll processed for ${mo} ${fyL(fy)}`);
  };
  ...
  const saveOffCycle = () => {
    ...
    const entry = {
      m: mo,
      t: 's',
      basic: +offCycleData.basic,
      hra: +offCycleData.hra,
      conv: +offCycleData.conv,
      med: +offCycleData.med,
      inc: +offCycleData.inc,
      oth: +offCycleData.oth,
      lop: +offCycleData.lop,
      adv: 0,
      pt: +offCycleData.pt,
      tds: +offCycleData.tds,
      note: offCycleData.note || 'Off-Cycle',
    };
    setPay((prev) => ({
      ...prev,
      [offCycleData.empId]: {
        ...prev[offCycleData.empId],
        [fy]: [...(prev[offCycleData.empId]?.[fy] || []), entry],
      },
    }));
    setShowOffCycle(false);
    setOffCycleData({
    ...
    alert(
      `Off-Cycle Payroll saved for ${
        emps.find((e) => e.id === offCycleData.empId)?.name
      }`
    );
  };
      ...
      >
        ...
        >
          ...
          <input
            ...
            onChange={(e) => (idR.current = e.target.value)}
          />
          <input
            style={{ ...sInp, marginTop: 15, marginBottom: 20 }}
            type="password"
            placeholder="Password"
            onChange={(e) => (pwR.current = e.target.value)}
          />
          <button
            style={{
              width: '100%',
  ...
  const TABS =
    ses?.role === 'a'
      ? ['dashboard', 'employees', 'attendance', 'ledger', 'payslips']
      : ['dashboard', 'attendance', 'ledger', 'payslips'];
  const ADMIN_DRIVE =
    'https://drive.google.com/drive/folders/1kq4pVPRpaycQczhgycGz0dGHLUn2LmG6?usp=sharing';
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h2 style={{ margin: 0 }}>
            {CO} — {ses.role === 'e' ? 'Employee Portal' : 'Admin'}
          </h2>
          <small>{AD}</small>
        </div>
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          {DRIVE_LINK && (
            ...
            >
              📂 {ses.role === 'a' ? 'Admin Drive' : 'My Folder'}
            </a>
          )}
          <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            <span style={{ fontSize: 13, fontWeight: 'bold' }}>FY</span>
            <input
              type="number"
              value={fy}
              onChange={(e) => setFy(e.target.value)}
              style={{ ...sInp, width: 80, padding: '6px' }}
            />
            <span style={{ fontSize: 13, fontWeight: 'bold' }}>{fyL(fy)}</span>
          </div>
          <button style={btn} onClick={() => setSes(null)}>
            Sign Out
          </button>
        </div>
      </div>
        ...
        {TABS.map((t) => (
          <button
            ...
            style={{
              ...
              background: 'none',
              border: 'none',
              borderBottom: tab === t ? '3px solid #1a1a2e' : 'none',
              cursor: 'pointer',
      ...
      {tab === 'dashboard' && (
        <div>
            ...
            {ses.role === 'a' && (
              <div style={{ marginLeft: 'auto', display: 'flex', gap: 10 }}>
                <button
                  ...
                  onClick={openBulkPayroll}
                >
                  + Run Bulk Payroll
                </button>
                <button
                  style={{ ...btn, background: '#185FA5', color: '#fff' }}
                  onClick={() => {
                ...
                <button
                  style={{ ...btn, background: '#1D9E75', color: '#fff' }}
                  onClick={() => {
                    const rows = [
                      [
                        'Employee',
          ...
          >
            <div style={card}>
              <div style={lbl}>
                {ses.role === 'a' ? 'Total Staff' : 'My Salary'}
              </div>
              <div style={{ fontSize: 24, fontWeight: 'bold' }}>
                {ses.role === 'a' ? emps.length : f$(myE?.basic)}
              </div>
            </div>
            <div style={card}>
              <div style={lbl}>
                {ses.role === 'a' ? 'Gross Month' : 'My YTD Gross'}
              </div>
              <div style={{ fontSize: 24, fontWeight: 'bold' }}>
                {ses.role === 'a'
                  ? f$(dTot.g)
                  : f$(
                      (pay[myE?.id]?.[fy] || []).reduce((s, r) => s + gr(r), 0)
                    )}
              </div>
            </div>
            <div style={card}>
              ...
              <div
                style={{ fontSize: 24, fontWeight: 'bold', color: '#D85A30' }}
              >
                {f$(dTot.d)}
              </div>
            </div>
            <div style={card}>
              <div style={lbl}>Net Amount</div>
              <div
                style={{ fontSize: 24, fontWeight: 'bold', color: '#1D9E75' }}
              >
                {f$(dTot.n)}
              </div>
            </div>
          ...
          {showBulk && ses.role === 'a' && (
            <div
              style={{ ...card, border: '1px solid #1a1a2e', marginBottom: 20 }}
            >
              <h3>
                Bulk Payroll for {mo} {fyL(fy)}
              </h3>
              <div style={{ overflowX: 'auto' }}>
                ...
                >
                  ...
                  <tbody>
                    {Object.keys(bulkData).map((eid) => {
                      const d = bulkData[eid];
                      const upd = (k, v) =>
                        setBulkData({ ...bulkData, [eid]: { ...d, [k]: v } });
                      return (
                        <tr key={eid}>
                          <td>{emps.find((e) => e.id === eid)?.name}</td>
                          <td>
                            <input
                              style={sInp}
                              type="number"
                              value={d.basic}
                              onChange={(e) => upd('basic', e.target.value)}
                            />
                          </td>
                          <td>
                            <input
                          ...
                          <td>
                            <input
                              ...
                              type="number"
                              value={d.inc}
                              onChange={(e) => upd('inc', e.target.value)}
                            />
                          </td>
                          <td>
                            <input
                              ...
                              type="number"
                              value={d.lop}
                              onChange={(e) => upd('lop', e.target.value)}
                            />
                          </td>
                          <td>
                            <input
                              ...
                              type="number"
                              value={d.pt}
                              onChange={(e) => upd('pt', e.target.value)}
                            />
                          </td>
          ...
          {showOffCycle && ses.role === 'a' && (
            <div
              style={{ ...card, border: '1px solid #185FA5', marginBottom: 20 }}
            >
              <h3>
                Run Off-Cycle Payroll for {mo} {fyL(fy)}
              </h3>
              <div
                style={{
                  display: 'grid',
              ...
              >
                ...
                <div style={{ gridColumn: '1/-1' }}>
                  <label style={lbl}>Note / Reason</label>
                  <input
                    style={sInp}
                    value={offCycleData.note}
                    placeholder="e.g. Arrears"
                    onChange={(e) =>
                      setOffCycleData({ ...offCycleData, note: e.target.value })
                    }
                  />
                </div>
              </div>
              <button
                ...
                onClick={saveOffCycle}
              >
                Save Off-Cycle Entry
              </button>
              <button style={btn} onClick={() => setShowOffCycle(false)}>
                Cancel
              </button>
            </div>
          )}
            ...
            >
              <thead>
                <tr style={{ background: '#f8f9fa', textAlign: 'left' }}>
                  ...
                  <th style={thS}>Net</th>
                  <th style={thS}>Payslip</th>
                </tr>
              </thead>
              <tbody>
                {emps
                  .filter((e) => (ses.role === 'a' ? true : e.id === ses.id))
                  .map((emp) => {
                    const rows = (pay[emp.id]?.[fy] || []).filter(
                      (r) => r.m === mo
                    );
                    return rows.map((r, i) => (
                      <tr
                      ...
                      >
                        ...
                        <td style={tdS}>{emp.desig}</td>
                        <td style={tdS}>{f$(r.basic)}</td>
                        <td style={tdS}>{f$(r.inc)}</td>
                        <td style={tdS}>{f$(gr(r))}</td>
                        <td style={tdS}>{f$(r.pt)}</td>
                        <td style={tdS}>{f$(r.tds)}</td>
          ...
          <div style={{ ...card, padding: 0, overflowX: 'auto' }}>
            ...
            >
              ...
              <tbody>
                {emps
                  .filter((e) =>
                    ses.role === 'a' ? e.status === 'Active' : e.id === ses.id
                  )
                  .map((e) => {
                    const a = att[e.id]?.[mo] || {};
                    const upd = (f, v) =>
                      ...
                      <tr key={e.id} style={{ borderBottom: '1px solid #eee' }}>
                        ...
                        <td>
                          <input
                            ...
                            disabled={ses.role !== 'a'}
                            type="number"
                            value={a.present !== undefined ? a.present : ''}
                            onChange={(x) => upd('present', x.target.value)}
                          />
                        </td>
                        <td>
                          <input
                            ...
                            disabled={ses.role !== 'a'}
                            type="number"
                            value={a.leave !== undefined ? a.leave : ''}
                            onChange={(x) => upd('leave', x.target.value)}
                          />
                        </td>
                        <td>
                          <input
                            ...
                            disabled={ses.role !== 'a'}
                            type="number"
                            value={a.bal !== undefined ? a.bal : ''}
                            onChange={(x) => upd('bal', x.target.value)}
                          />
                        </td>
                        <td>
                          <input
                            ...
                            disabled={ses.role !== 'a'}
                            type="number"
                            value={a.lop !== undefined ? a.lop : ''}
                            onChange={(x) => upd('lop', x.target.value)}
                          />
                        </td>
                        <td>
                          <input
                            ...
                            disabled={ses.role !== 'a'}
                            value={a.comments || ''}
                            onChange={(x) => upd('comments', x.target.value)}
                          />
                        </td>
                      </tr>
                    );
          ...
          <div style={{ ...card, padding: 0, overflowX: 'auto' }}>
            ...
            >
              ...
              <tbody>
                {emps
                  .filter((e) =>
                    ses.role === 'a' ? !lEmp || e.id === lEmp : e.id === ses.id
                  )
                  .flatMap((e) =>
                    (pay[e.id]?.[fy] || [])
                      .filter((r) => !mo || r.m === mo)
                      .map((r, i) => (
                        ...
                        >
                          ...
                          <td>{f$(r.inc)}</td>
                          <td>{f$(gr(r))}</td>
                          <td style={{ fontWeight: 'bold' }}>{f$(txInc(r))}</td>
                          <td style={{ color: '#1D9E75', fontWeight: 'bold' }}>
                            {f$(np(r))}
                          </td>
                        </tr>
                      ))
      ...
      {tab === 'payslips' && (
        <div style={card}>
          ...
          >
            {ses.role === 'a' && (
              <div>
                <label style={lbl}>Select Staff</label>
                <select
                  style={sInp}
                  value={pEmp}
                  onChange={(e) => setPEmp(e.target.value)}
                >
                  <option value="">Select...</option>
                  {emps.map((e) => (
                    <option key={e.id} value={e.id}>
            ...
            <div>
              ...
              <input
                ...
                style={sInp}
                value={pFy}
                onChange={(e) => setPFy(e.target.value)}
              />
            </div>
            <div>
